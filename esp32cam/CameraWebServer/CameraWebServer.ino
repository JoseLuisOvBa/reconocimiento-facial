 ...
 *y agraga conexion con MQTT para recibir la instruccion de apertura de puerta 
 *con un servo motor
 *Componet     PinESP32CAM  EStados Logicos
...
//Datos de WiFi
const char* ssid = "OviRab";           // Pon aquí el nombre de la red a la que deseas conectarte
const char* password = "99121976";     // Escribe la contraseña de dicha red
...
void callback(char* topic, byte* message, unsigned int length) {
  ...
  if (String(topic) == "codigoIoT/py/puerta") {  // En caso de recibirse mensaje en el tema codigoIoT/py/puerta
    if(messageTemp > 60){
      Serial.println("Abrir puerta");
       digitalWrite(33,0);
      myservo.write(180);
    }// fin del if (String(topic) == "codigoIoT/py/puerta")
